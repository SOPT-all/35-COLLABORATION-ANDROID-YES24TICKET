...
val defaultYes24TicketTypography = Yes24TicketTypography(
    //Head
    headBold36 = TextStyle(
        fontFamily = AppleSanDolGothicBold,
        fontSize = 36.sp,
        lineHeight = 43.sp,
        letterSpacing = 0.sp
    ),
    headExtraBold24 = TextStyle(
        fontFamily = AppleSanDolGothicExtraBold,
        fontSize = 24.sp,
        lineHeight = 29.sp,
        letterSpacing = 0.048.sp
    ),
    headExtraBold20 = TextStyle(
        fontFamily = AppleSanDolGothicExtraBold,
        fontSize = 20.sp,
        lineHeight = 20.sp,
        letterSpacing = 0.sp
    ),
    headExtraBold17 = TextStyle(
        fontFamily = AppleSanDolGothicExtraBold,
        fontSize = 17.sp,
        lineHeight = 17.sp,
        letterSpacing = 0.sp
    ),
    headBold15 = TextStyle(
        fontFamily = AppleSanDolGothicBold,
        fontSize = 15.sp,
        lineHeight = 18.sp,
        letterSpacing = 0.sp
    ...
    titleExtraBold17 = TextStyle(
        fontFamily = AppleSanDolGothicExtraBold,
        fontSize = 17.sp,
        lineHeight = 20.sp,
        letterSpacing = 0.sp
    ),
    titleBold15 = TextStyle(
        fontFamily = AppleSanDolGothicBold,
        fontSize = 15.sp,
        lineHeight = 18.sp,
        letterSpacing = 0.sp
    ),
    titleBold13 = TextStyle(
        fontFamily = AppleSanDolGothicBold,
        fontSize = 13.sp,
        lineHeight = 20.sp,
        letterSpacing = 0.sp
    ),
    titleExtraBold12 = TextStyle(
        fontFamily = AppleSanDolGothicExtraBold,
        fontSize = 12.sp,
        lineHeight = 20.sp,
    ...
    //Button
    buttonExtraBold18 = TextStyle(
        fontFamily = AppleSanDolGothicExtraBold,
        fontSize = 18.sp,
        lineHeight = 21.sp,
        letterSpacing = 0.sp
    ),
    buttonSemiBold19 = TextStyle(
        fontFamily = AppleSanDolGothicSemiBold,
        fontSize = 19.sp,
        lineHeight = 20.sp,
        letterSpacing = 0.19.sp
    ),
    buttonBold14 = TextStyle(
        fontFamily = AppleSanDolGothicBold,
        fontSize = 14.sp,
        lineHeight = 17.sp,
        letterSpacing = 0.sp
    ),
    buttonBold13 = TextStyle(
        fontFamily = AppleSanDolGothicBold,
        fontSize = 13.sp,
        lineHeight = 20.sp,
        letterSpacing = (-0.2).sp
    ),
    buttonRegular13 = TextStyle(
        fontFamily = AppleSanDolGothicRegular,
        fontSize = 13.sp,
        lineHeight = 20.sp,
        letterSpacing = (-0.2).sp
